  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Welcome to SafeTech Kerala, a joint digital safety and responsibility campaign by Goverment of Keralam and Kerala State IT Mission (KSITM). Take the pledge, test your Cyber IQ, and safeguard your digital footprint today.
        </motion.p>
